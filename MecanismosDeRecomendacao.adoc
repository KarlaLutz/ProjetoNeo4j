...
* *Cypher Queries*
** <<criando_ofertas_para_o_e-mail_retargeting, Criando Ofertas para o E-mail Retargeting>>
** <<criando_as_queries_conforme_regras_de_negócio_pré-estabelecidas, Criando as Queries Conforme Regras de Negócio Pré-Estabelecidas>>
** <<criando_o_e-mail_retargeting , Criando o E-mail Retargeting>>
